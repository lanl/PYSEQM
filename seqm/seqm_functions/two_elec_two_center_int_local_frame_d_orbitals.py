...
#        LL = L.bool()
        ...
        coreYYLocal[...,9] = tore[nj[YY]]*riPM6b[YYY,3-1]  ##PP
        coreYYLocal[...,14] = tore[nj[YY]]*riYY[...,44] ##DD
        coreYYLocal[...,16] = tore[nj[YY]]*riYY[...,17]
        coreYYLocal[...,20] = tore[nj[YY]]*riYY[...,20]  ##DD
        coreYYLocal[...,21] = tore[nj[YY]]*riYY[...,10]
        coreYYLocal[...,24] = tore[nj[YY]]*riYY[...,11]
        coreYYLocal[...,27] = tore[nj[YY]]*riYY[...,14]  ## DD
        ##print(coreYYLocal)
        coreYYLocal[...,45] = tore[ni[YY]]*riPM6a[YYY,1-1]  
        coreYYLocal[...,47] = tore[ni[YY]]*riPM6a[YYY,12-1]
        coreYYLocal[...,51] = tore[ni[YY]]*riPM6a[YYY,5-1]
        coreYYLocal[...,54] = tore[ni[YY]]*riPM6a[YYY,11-1]
        coreYYLocal[...,59] = tore[ni[YY]]*riYY[...,1980]
        coreYYLocal[...,61] = tore[ni[YY]]*riYY[...,765]
        coreYYLocal[...,65] = tore[ni[YY]]*riYY[...,900]
        ...
        if(drho_corea.sum() > 0 or drho_coreb.sum() > 0 ):
            ...
            coreYYLocal[Ycore,16] = tore[nj[YY][Ycore]]*(DPUz_Sq[Ycore]*1.000000*1.000000)
            coreYYLocal[Ycore,20] = tore[nj[YY][Ycore]]*(DDq_Sq[Ycore]*1.000000*1.000000 + DDQtzx_onehalfQtxy_Sq[Ycore]*0.666667*1.000000)
            coreYYLocal[Ycore,21] = tore[nj[YY][Ycore]]*(DSQtzx_onehalfQtxy_Sq[Ycore]*1.154701*1.000000)
            coreYYLocal[Ycore,24] = tore[nj[YY][Ycore]]*(DPUz_Sq[Ycore]*1.154701*1.000000)
            coreYYLocal[Ycore,27] = tore[nj[YY][Ycore]]*(DDq_Sq[Ycore]*1.000000*1.000000 + DDQtzx_onehalfQtxy_Sq[Ycore]*1.333333*1.000000)
    
    
    
            coreYYLocal[Ycore,59] = tore[ni[YY][Ycore]]*(Sq_DDq[Ycore]*1.000000*1.000000 + Sq_DDQtzx_onehalfQtxy[Ycore]*1.000000*-1.333333)
            coreYYLocal[Ycore,61] = tore[ni[YY][Ycore]]*(Sq_DPUz[Ycore]*1.000000*1.000000)
            coreYYLocal[Ycore,65] = tore[ni[YY][Ycore]]*(Sq_DDq[Ycore]*1.000000*1.000000 + Sq_DDQtzx_onehalfQtxy[Ycore]*1.000000*0.666667)
            coreYYLocal[Ycore,66] = tore[ni[YY][Ycore]]*(Sq_DSQtzx_onehalfQtxy[Ycore]*1.000000*1.154701)
