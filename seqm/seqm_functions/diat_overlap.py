...
def diatom_overlap_matrix(ni, nj, xij, rij, zeta_a, zeta_b, qn_int):
    ...
    """
    print(
        "DON'T USE THIS FUNCTION TO CALCULATE OVERLAP. THIS FUNCTION HAS BEEN DEPRECATED. USE diatom_overlap_matrix_PM6_SP() INSTEAD."
    )
    dtype = xij.dtype
    device = xij.device
    ...
    S111[jcall2] = (
        torch.pow(zeta_a[jcall2, 0] * zeta_b[jcall2, 0] * rij[jcall2] ** 2, 1.5)
    ...
    # print(id(S111))
    S111[jcall4] = (
        torch.pow(zeta_b[jcall4, 0] * zeta_a[jcall4, 0], 2.5)
        * rij[jcall4] ** 5
        * (
    ...
    S211[jcall4] = (
        torch.pow(zeta_b[jcall4, 0] * zeta_a[jcall4, 1], 2.5)
        * rij[jcall4] ** 5
        * (
    ...
    S121[jcall4] = (
        torch.pow(zeta_b[jcall4, 1] * zeta_a[jcall4, 0], 2.5)
        * rij[jcall4] ** 5
        * (
    ...
    w = torch.pow(zeta_b[jcall4, 1] * zeta_a[jcall4, 1], 2.5) * rij[jcall4] ** 5 / 16.0
    S221[jcall4] = -w * (
    ...
    di[jcall4, 1, 1] = -S221[jcall4] * casb[jcall4] ** 2 + S222[jcall4] * (
        cacb[jcall4] ** 2 + sa[jcall4] ** 2
    )
    di[jcall4, 1, 2] = -S221[jcall4] * casb[jcall4] * sasb[jcall4] + S222[jcall4] * (
        cacb[jcall4] * sacb[jcall4] - sa[jcall4] * ca[jcall4]
    )
    di[jcall4, 1, 3] = -S221[jcall4] * casb[jcall4] * cb[jcall4] - S222[jcall4] * cacb[jcall4] * sb[jcall4]
    di[jcall4, 2, 1] = -S221[jcall4] * sasb[jcall4] * casb[jcall4] + S222[jcall4] * (
        sacb[jcall4] * cacb[jcall4] - ca[jcall4] * sa[jcall4]
    )
    di[jcall4, 2, 2] = -S221[jcall4] * sasb[jcall4] ** 2 + S222[jcall4] * (
        sacb[jcall4] ** 2 + ca[jcall4] ** 2
    )
    di[jcall4, 2, 3] = -S221[jcall4] * sasb[jcall4] * cb[jcall4] - S222[jcall4] * sacb[jcall4] * sb[jcall4]
    di[jcall4, 3, 1] = -S221[jcall4] * cb[jcall4] * casb[jcall4] - S222[jcall4] * sb[jcall4] * cacb[jcall4]
    di[jcall4, 3, 2] = -S221[jcall4] * cb[jcall4] * sasb[jcall4] - S222[jcall4] * sb[jcall4] * sacb[jcall4]
    di[jcall4, 3, 3] = -S221[jcall4] * cb[jcall4] ** 2 + S222[jcall4] * sb[jcall4] ** 2
