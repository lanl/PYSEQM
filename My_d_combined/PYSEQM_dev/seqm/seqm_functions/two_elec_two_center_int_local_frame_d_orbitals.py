...
##    t = time.time()
    ...
    if(YY.sum() > 0 ):
        ...
        ######
        ### dda0 and ddb0 should bswapped. Don't know why.
        ######
        dda0 = ddb0d[YY]
        ddb0 = dda0d[YY]
        ######
...
####
        ...
        print('r0**2, rm2,, rm2, rhoDD0DD',r0**2, (r0-dda0)**2, (r0+dda0)**2, rhoDD0DD, rhoDDDD0)
