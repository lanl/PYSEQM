...
from seqm.api import Constants, Electronic_Structure, Molecule, geomeTRIC_optimization, read_xyz
...
species = torch.as_tensor([[6, 6, 6, 6, 6, 6, 1, 1, 1, 1, 1, 1]], dtype=torch.int64, device=device)
